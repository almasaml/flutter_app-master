      ...
      body: Container(
        ...
        child: Column(children: [
          ...
          Container(
            ...
            child: Text("Mukhtarul Hadist ialah kitab Hadist yang mencakup hadist-hadist shahih menjadi satu, Hadist yang mengandung arti mengenai hukum, budi pekerti atau akhlak, etika bersosialisasi serta hal-hal terbaik lain yang tentu saja untuk dijadikan panutan bagi kaum muslimin dalam kehidupan bermasyarakat.",
          ...
          Container(
                ...
                child: ListTile(
                  ...
                  onTap: () {Navigator.push(context, MaterialPageRoute(builder: (context) => MukhtarulHadist()));}
                ),
              ),
          Container(
                decoration: BoxDecoration(
                ...
                child: ListTile(
                  ...
                  onTap: () {Navigator.push(context, MaterialPageRoute(builder: (context) => HadistPilihan()));}
                ),
              ),
          Container(height: 12.0),
        ]),
