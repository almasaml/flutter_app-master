                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: ListTile(
                          ...
                          onTap: () {
                            Navigator.push(context, MaterialPageRoute(builder: (context) => HadistPilihanBab(dataHadist: allHadist.getRange(0, 9).toList(), titlePage: "Hadist Bab 1 - Bab 10")));
                          }),
                    ),
                    Container(
                      decoration: BoxDecoration(color: Color.fromARGB(255, 234, 234, 235), borderRadius: BorderRadius.circular(10)),
                      ...
                      child: ListTile(
                          ...
                          trailing: Icon(Icons.keyboard_arrow_right),
                          onTap: () {
                            Navigator.push(context, MaterialPageRoute(builder: (context) => HadistPilihanBab(dataHadist: allHadist.getRange(10, 19).toList(), titlePage: "Hadist Bab 11 - Bab 20")));
                          }),
                    ),
                    Container(
                      decoration: BoxDecoration(color: Color.fromARGB(255, 234, 234, 235), borderRadius: BorderRadius.circular(10)),
                      ...
                      child: ListTile(
                          ...
                          trailing: Icon(Icons.keyboard_arrow_right),
                          onTap: () {
                            Navigator.push(context, MaterialPageRoute(builder: (context) => HadistPilihan3()));
                          }),
                    ),
                    Container(
                      decoration: BoxDecoration(color: Color.fromARGB(255, 234, 234, 235), borderRadius: BorderRadius.circular(10)),
                      ...
                      child: ListTile(
                          ...
                          trailing: Icon(Icons.keyboard_arrow_right),
                          onTap: () {
                            Navigator.push(context, MaterialPageRoute(builder: (context) => HadistPilihan4()));
                          }),
                    ),
                    Container(
                      decoration: BoxDecoration(color: Color.fromARGB(255, 234, 234, 235), borderRadius: BorderRadius.circular(10)),
                      ...
                      child: ListTile(
                          ...
                          trailing: Icon(Icons.keyboard_arrow_right),
                          onTap: () {
                            Navigator.push(context, MaterialPageRoute(builder: (context) => HadistPilihan5()));
                          }),
                    ),
                    Container(
                      decoration: BoxDecoration(color: Color.fromARGB(255, 234, 234, 235), borderRadius: BorderRadius.circular(10)),
                      ...
                      child: ListTile(
                          ...
                          trailing: Icon(Icons.keyboard_arrow_right),
                          onTap: () {
                            Navigator.push(context, MaterialPageRoute(builder: (context) => HadistPilihan6()));
                          }),
                    ),
                    Container(
                      decoration: BoxDecoration(color: Color.fromARGB(255, 234, 234, 235), borderRadius: BorderRadius.circular(10)),
                      ...
                      child: ListTile(
                          ...
                          trailing: Icon(Icons.keyboard_arrow_right),
                          onTap: () {
                            Navigator.push(context, MaterialPageRoute(builder: (context) => HadistPilihan7()));
                          }),
                    ),
                    Container(
                      decoration: BoxDecoration(color: Color.fromARGB(255, 234, 234, 235), borderRadius: BorderRadius.circular(10)),
                      ...
                      child: ListTile(
                          ...
                          trailing: Icon(Icons.keyboard_arrow_right),
                          onTap: () {
                            Navigator.push(context, MaterialPageRoute(builder: (context) => HadistPilihan8()));
                          }),
                    ),
                  ],
                ),
