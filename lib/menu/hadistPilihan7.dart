...
class HadistPilihan7 extends StatefulWidget {
  const HadistPilihan7({Key? key}) : super(key: key);

  @override
  State<HadistPilihan7> createState() => _HadistPilihan7State();
}

class _HadistPilihan7State extends State<HadistPilihan7> {
  ...
  Future<List<HadistPilihanModel?>> _getData() async {
    ...
    allHadist = allHadist.sublist(60, 71);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text("Hadist Bab 61 - Bab 70"),
