...
class _JadwalSholatState extends State<JadwalSholat> {
  ...
  var formattedDate = DateFormat('EEEE, d MMM, yyyy, h:mm a', "id_ID").format(DateTime.now());  
  var tgl = new DateFormat('yyyy/MM/dd') .format(DateTime.now());
