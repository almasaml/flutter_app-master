...
class HadistPilihan8 extends StatefulWidget {
  const HadistPilihan8({Key? key}) : super(key: key);

  @override
  State<HadistPilihan8> createState() => _HadistPilihan8State();
}

class _HadistPilihan8State extends State<HadistPilihan8> {
  ...
  Future<List<HadistPilihanModel?>> _getData() async {
    ...
    allHadist = allHadist.sublist(70, 79);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text("Hadist Bab 71 - Bab 79"),
