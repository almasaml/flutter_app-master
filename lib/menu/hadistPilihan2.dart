...
class HadistPilihan2 extends StatefulWidget {
  const HadistPilihan2({Key? key}) : super(key: key);

  @override
  State<HadistPilihan2> createState() => _HadistPilihan2State();
}

class _HadistPilihan2State extends State<HadistPilihan2> {
  ...
  Future<List<HadistPilihanModel?>> _getData() async {
    ...
    allHadist = allHadist.sublist(10, 21);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text("Hadist Bab 11 - Bab 20"),
