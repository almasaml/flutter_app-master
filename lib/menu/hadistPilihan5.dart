...
class HadistPilihan5 extends StatefulWidget {
  const HadistPilihan5({Key? key}) : super(key: key);

  @override
  State<HadistPilihan5> createState() => _HadistPilihan5State();
}

class _HadistPilihan5State extends State<HadistPilihan5> {
  ...
  Future<List<HadistPilihanModel?>> _getData() async {
    ...
    allHadist = allHadist.sublist(40, 51);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text("Hadist Bab 41 - Bab 50"),
